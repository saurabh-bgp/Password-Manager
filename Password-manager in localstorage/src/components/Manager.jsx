            ...
            <tbody className="bg-green-200 text-black">
              {passwordArray.map((item, index)=>{
                ...
                <div className="flex items-center justify-center">
                  ...
                  <div className="size-5 copyBtn cursor-pointer mx-4" onClick={()=>{copyText(item.site)}}>
                ...
                <div className="flex justify-center items-center">
                  ...
                  <div className="size-5 copyBtn cursor-pointer mx-4" onClick={()=>{copyText(item.username)}}>
                <img src="icons/copyicon.png" alt="copy icon" />
                </div>
                </div>
                </td>
                ...
                <div className="flex justify-center items-center">
                  ...
                  <div className="size-5 copyBtn cursor-pointer mx-4" onClick={()=>{copyText(item.password)}}>
                <img src="icons/copyicon.png" alt="copy icon" />
                </div>
                </div>
                </td>
                ...
                <span onClick={()=>{editPassword(item.id)}}>
                  <img className="w-6  cursor-pointer" src="icons/editicon.png" alt="" />
                </span>
                <span onClick={()=>{deletePassword(item.id)}}>
                  <img className="w-6 ml-5 cursor-pointer" src="icons/deleteicon.png" alt="" />
                </span>
                </td>
              </tr>
              })}
